...
export function EditRequestForm({
  ...
  async function onSubmit(values: EventRequestInput) {
    setServerError(null);
    const result = await updateEventViaTokenAction(companySlug, eventId, token, values);
    if (result?.error) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-base font-medium">Tu solicitud</CardTitle>
        <CardDescription>Puedes editarla mientras siga pendiente de revisión.</CardDescription>
      </CardHeader>
      <CardContent>
