...
import { getWorkOrderPdfForPublicAccess, WorkOrderError } from "@/services/work-order.service";
...
export async function GET(
  ...
  try {
    const { buffer, filename } = await getWorkOrderPdfForPublicAccess(companySlug, eventId, token);
